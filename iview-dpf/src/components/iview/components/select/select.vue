    ...
    >
        ...
        <transition name="transition-drop">
            <Drop
                    ...
                    v-transfer-dom
            >
                <ul v-show="showNotFoundLabel && !allowCreate" :class="[prefixCls + '-not-found']"><li>{{ localeNotFoundText }}123123</li></ul>
                <ul >
                ...
                <ul v-show="loading" :class="[prefixCls + '-loading']">{{ localeLoadingText }}12312321</ul>
            </Drop>
        </transition>
    </div>
</template>
